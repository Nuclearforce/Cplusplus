...
TFile f_hist("../histogram/14C/test.root", "recreate");
...
void three_leaves_14()
{
    ...
    Clover1->Add(time_background[1][0],-(Ge_subtract/background_size));
    Clover1->Add(time_background[1][1],-(Ge_subtract/background_size));
    Clover1->Add(time_background[1][2],-(Ge_subtract/background_size));
    Clover1->Add(time_background[1][3],-(Ge_subtract/background_size));
    Clover1->Add(time_background_pg[1][0],-(Ge_subtract/background_size));
    Clover1->Add(time_background_pg[1][1],-(Ge_subtract/background_size));
    Clover1->Add(time_background_pg[1][2],-(Ge_subtract/background_size));
    Clover1->Add(time_background_pg[1][3],-(Ge_subtract/background_size));
    Clover3->Add(hPixieADC_pg[3][0],1);
    Clover3->Add(hPixieADC_pg[3][1],1);
    Clover3->Add(hPixieADC_pg[3][2],1);
    Clover3->Add(hPixieADC_pg[3][3],1);
    Clover3->Add(time_background[3][0],-(Ge_subtract/background_size));
    Clover3->Add(time_background[3][1],-(Ge_subtract/background_size));
    Clover3->Add(time_background[3][2],-(Ge_subtract/background_size));
    Clover3->Add(time_background[3][3],-(Ge_subtract/background_size));
    Clover3->Add(time_background_pg[3][0],-(Ge_subtract/background_size));
    Clover3->Add(time_background_pg[3][1],-(Ge_subtract/background_size));
    Clover3->Add(time_background_pg[3][2],-(Ge_subtract/background_size));
    Clover3->Add(time_background_pg[3][3],-(Ge_subtract/background_size));
    ...
    Clover1ab->Add(time_background_not_dopler[1][0],-(Ge_subtract/background_size));
    Clover1ab->Add(time_background_not_dopler[1][1],-(Ge_subtract/background_size));
    Clover1ab->Add(time_background_not_dopler[1][2],-(Ge_subtract/background_size));
    Clover1ab->Add(time_background_not_dopler[1][3],-(Ge_subtract/background_size));
    Clover1ab->Add(time_background_not_dopler_pg[1][0],-(Ge_subtract/background_size));
    Clover1ab->Add(time_background_not_dopler_pg[1][1],-(Ge_subtract/background_size));
    Clover1ab->Add(time_background_not_dopler_pg[1][2],-(Ge_subtract/background_size));
    Clover1ab->Add(time_background_not_dopler_pg[1][3],-(Ge_subtract/background_size));
    ...
    Clover3ab->Add(time_background_not_dopler[3][0],-(Ge_subtract/background_size));
    Clover3ab->Add(time_background_not_dopler[3][1],-(Ge_subtract/background_size));
    Clover3ab->Add(time_background_not_dopler[3][2],-(Ge_subtract/background_size));
    Clover3ab->Add(time_background_not_dopler[3][3],-(Ge_subtract/background_size));
    Clover3ab->Add(time_background_not_dopler_pg[3][0],-(Ge_subtract/background_size));
    Clover3ab->Add(time_background_not_dopler_pg[3][1],-(Ge_subtract/background_size));
    Clover3ab->Add(time_background_not_dopler_pg[3][2],-(Ge_subtract/background_size));
    Clover3ab->Add(time_background_not_dopler_pg[3][3],-(Ge_subtract/background_size));
...
void first_loop(){
    ...
    for (entry_id = 0, entry_size = TRenergy.GetSize(); entry_id < entry_size; ++entry_id) {
        ...
        if( (mod==1 && (chn==8||chn==9||chn==10||chn==11||chn==12||chn==13||chn==14||chn==15)) || (mod==2 && (chn==8||chn==9||chn==10||chn==11||chn==12||chn==13||chn==14||chn==15)) || (mod==3 && (chn==7||chn==8||chn==9||chn==10||chn==11||chn==12||chn==13||chn==14||chn==15)) ) {
            ...
            //if( (calib_en>lower_lim && calib_en<upper_lim)){//old particle gate
...
void second_loop(){
    ...
    for (entry_id = 0, entry_size = TRenergy.GetSize(); entry_id < entry_size; ++entry_id) {
        ...
        if(allready_filled==false && calib_en>20 && ring_sector_time_gate==true && abs(ring_en_for_hist - sector_en_for_hist)<diagonal_cut_width){
            ...
            else if ((time-ring_time+200)>203&&(time-ring_time+200)<216){
